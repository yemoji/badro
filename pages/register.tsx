...
export default function Login() {
  return (
    <Grid justifyContent="space-evenly" sx={{ background: "url('/login/bg.png')", backgroundSize: "cover", minHeight: "100vh", py: "10%" }} container>
      <Form alignItems="center" py={2} px={4} container flexDirection="column" item xs={10} md={7} lg={5}>
      <Grid>
      ...
      <Grid item xs={3} position="relative" sx={{display: {xs: "none",md:  "block"}} }>
